"""
Django settings for pedes project.
...
MIDDLEWARE = [
    ...
    "pedes.middleware.ViewCountMiddleware"
]

ROOT_URLCONF = "pedes.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "accounts.context_processors.view_count_processor"
            ],
        },
    },
]

WSGI_APPLICATION = "pedes.wsgi.application"
